...
/**
 * 此XNode是对{@link org.w3c.dom.Node}对象做了封装和解析
...
public class XNode {
  ...
  /**
   * 此构造会调用{@link #parseAttributes(Node)}和{@link #parseBody(Node)}方法解析{@link org.w3c.dom.Node}对象中的信息，
   * 初始化节点属性结合{@link #attributes} 和 节点内容{@link #body}，具体的初始化过程参见具体的方法。
   * @param xpathParser
   * @param node
   * @param variables
   */
